...
class SubmissionDto(object):
    ...
    def __init__(self, submission_id=None, platform=None, created_at=None, active=None, commit_hash=None, commit_message=None, branch_name=None, status=None, build_log_key=None, test_log_key=None):  # noqa: E501
